...
/-!
# Theorem C: quotients of permutation modules
...
/-- **Theorem C (quotients of permutation modules).** A quotient of a
...
/-- The final assertion of Theorem C: every nonzero module over the group
